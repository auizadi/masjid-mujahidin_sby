                                    ...
                                    <table class="table">
                                        <thead>
                                          ...
                                          <tbody class="table-group-divider">
                                            <tr>
                                              <th scope="row">1</th>
                                              <td>Prestasi Gemilang Siswa Yayasan Masjid Mujahidin Surabaya</td>
                                              <td>Uncategorized</td>
                                              <td>Prestasi Gemilang Siswa Yayasan Masjid Mujahidin Surabaya Yayasan Masjid Mujahidin Surabaya kembali menorehkan...</td>
                                              <td>8 May 2024</td>
                                              <td>Masdinn</td>
                                            ...
                                            <tr>
                                              <th scope="row">2</th>
                                              <td>Liputan Acara Akhirussanah SMA MUJAHIDIN Surabaya Tahun Pelajaran 2023-2024</td>
                                              <td>Uncategorized</td>
                                              <td>Liputan Acara Akhirussanah SMA MUJAHIDIN Surabaya Tahun Pelajaran 2023-2024 Surabaya, 26 Mei 2024 - SMA Mujahidin...</td>
                                              <td>27 May 2024</td>
                                              <td>Masdinn</td>
                                              <td><button class="btn btn-primary"><i class="fa fa-edit"></i></button>
                                                  <button class="btn btn-danger"><i class="fa fa-trash"></i></button>
