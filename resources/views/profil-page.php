...
<html lang="en">
  ...
  <div class="container-fluid mt-4">
    ...
    <div class="col-6">
      ...
      <h4>Membangun Harmoni, Menebar Kasih, Menyongsong Kemajuan Bersama Umat.</h4>
    </div>
    <div class="col-6">
  ...
  <div class="container">
    <div class="row justify-content-center">
      <div class="col">
        <p class="my-3 fw-bold text-success-emphasis">SEJARAH SINGKAT</p>
  ...
  <div class="container">
    <div class="row justify-content-center">
      <div class="col text-center">
        ...
        <h3 class="fw-bold text-center">Pendidikan Berkualitas</h3>
  ...
  <div class="container rounded-3 bg-light my-4 shadow-lg p-4 mb-4">
    <div class="container">
      ...
      <div class="col">
        ...
        <p class="display-3">Cerita Kami</p>
    ...
    <div class="row">
      <div class="col">
        <p class="text-center my-3 display-3 text-success fw-semibold">400+</p>
        <p class="text-center my-3 text-secondary">SISWA SISWI</p>
      </div>
      <div class="col">
        <p class="text-center my-3 display-3 text-success fw-semibold">400+</p>
        <p class="text-center my-3 text-secondary">SISWA SISWI</p>
